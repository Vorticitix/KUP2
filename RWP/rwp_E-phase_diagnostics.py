...
if __name__ == "__main__":
	...
	lons  = filein.variables['longitude'][:]
	lats  = filein.variables['latitude'][:]
	...
	for i in range(noLats):
		latid[i] = 90-res*i
		deg_len[i] = circumference(latid[i])/360 # the length of one degree longitude at a given latitude circle
		cc6[i] = 1/(2*res*deg_len[i])
