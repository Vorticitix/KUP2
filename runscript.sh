...
mkdir /storage/climatestor/PleioCEP/doensen/data/cyclone

cd /storage/climatestor/PleioCEP/doensen/data/cyclone
...
#cdo mergetime $datpath/SLP/BPRD_trans_h1_PSL_`/usr/bin/expr $yy - 1`_DJF.nc $datpath/SLP/BPRD_trans_h1_PSL_$yy"_"DJF.nc $datpath/SLP/BPRD_trans_h1_PSL_`/usr/bin/expr $yy + 1`_DJF.nc $datpath/SLP/BPRD_trans_h1_PSL_`/usr/bin/expr $yy + 2`_DJF.nc $datpath/SLP/BPRD_trans_h1_PSL_`/usr/bin/expr $yy + 3`_DJF.nc $datpath/SLP/BPRD_trans_h1_PSL_`/usr/bin/expr $yy + 4`_DJF.nc $datpath/SLP/BPRD_trans_h1_PSL_`/usr/bin/expr $yy + 5`_DJF.nc $datpath/SLP/BPRD_trans_h1_PSL_`/usr/bin/expr $yy + 6`_DJF.nc $datpath/SLP/BPRD_trans_h1_PSL_`/usr/bin/expr $yy + 7`_DJF.nc $datpath/SLP/BPRD_trans_h1_PSL_`/usr/bin/expr $yy + 8`_DJF.nc $datpath/SLP/BPRD_trans_h1_PSL_`/usr/bin/expr $yy + 9`_DJF.nc tmpslp.nc

#cdo -O mergetime $datpath/TRANS.3501BP.cam.h1.$yy"-"01-01.sel.nc $datpath/TRANS.3501BP.cam.h1.`/usr/bin/expr $yy + 1`-01-01.sel.nc $datpath/TRANS.3501BP.cam.h1.`/usr/bin/expr $yy + 2`-01-01.sel.nc  $datpath/TRANS.3501BP.cam.h1.`/usr/bin/expr $yy + 3`-01-01.sel.nc $datpath/TRANS.3501BP.cam.h1.`/usr/bin/expr $yy + 4`-01-01.sel.nc $datpath/TRANS.3501BP.cam.h1.`/usr/bin/expr $yy + 5`-01-01.sel.nc $datpath/TRANS.3501BP.cam.h1.`/usr/bin/expr $yy + 6`-01-01.sel.nc  $datpath/TRANS.3501BP.cam.h1.`/usr/bin/expr $yy + 7`-01-01.sel.nc $datpath/TRANS.3501BP.cam.h1.`/usr/bin/expr $yy + 8`-01-01.sel.nc $datpath/TRANS.3501BP.cam.h1.`/usr/bin/expr $yy + 9`-01-01.sel.nc TRANS.3501BP.cam.h1.$yy"_"`/usr/bin/expr $yy + 9`"_"01-01.sel.nc

#cdo -O mergetime $datpath/TRANS.3501BP.RCP85.cam.h1.$yy"-"01-01.sel.nc $datpath/TRANS.3501BP.RCP85.cam.h1.`/usr/bin/expr $yy + 1`-01-01.sel.nc $datpath/TRANS.3501BP.RCP85.cam.h1.`/usr/bin/expr $yy + 2`-01-01.sel.nc  $datpath/TRANS.3501BP.RCP85.cam.h1.`/usr/bin/expr $yy + 3`-01-01.sel.nc $datpath/TRANS.3501BP.RCP85.cam.h1.`/usr/bin/expr $yy + 4`-01-01.sel.nc $datpath/TRANS.3501BP.RCP85.cam.h1.`/usr/bin/expr $yy + 5`-01-01.sel.nc TRANS.3501BP.RCP85.cam.h1.$yy"_"`/usr/bin/expr $yy + 5`"_"01-01.sel.nc

#cdo -O  mergetime $datpath/TRANS.3501BP.cam2.h1.$yy"-"01-01.PRECT_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy + 1`-01-01.PRECT_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy + 2`-01-01.PRECT_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy + 3`-01-01.PRECT_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy + 4`-01-01.PRECT_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy + 5`-01-01.PRECT_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy`_`/usr/bin/expr $yy + 5`.PRECT_merged.nc

#cdo -O mergetime $datpath/TRANS.3501BP.cam2.h1.$yy"-"01-01.PSL_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy + 1`-01-01.PSL_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy + 2`-01-01.PSL_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy + 3`-01-01.PSL_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy + 4`-01-01.PSL_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy + 5`-01-01.PSL_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy`_`/usr/bin/expr $yy + 5`.PSL_merged.nc

#cdo mergetime $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy`-01-01.PRECT_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy`-01-01.PRECT_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy`-01-01.PRECT_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy`-01-01.PRECT_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy`-01-01.PRECT_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy`-01-01.PRECT_py.nc $datpath/tempprec.nc

#cdo mergetime $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy`-01-01.PSL_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy`-01-01.PSL_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy`-01-01.PSL_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy`-01-01.PSL_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy`-01-01.PSL_py.nc $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy`-01-01.PSL_py.nc $datpath/temppsl.nc



#cdo mergetime $datpath/Precipitation/DJF/BPRD_trans_precip_`/usr/bin/expr $yy - 1`_TOTAL_DJF.nc $datpath/Precipitation/DJF/BPRD_trans_precip_$yy"_"TOTAL_DJF.nc $datpath/Precipitation/DJF/BPRD_trans_precip_`/usr/bin/expr $yy + 1`_TOTAL_DJF.nc $datpath/Precipitation/DJF/BPRD_trans_precip_`/usr/bin/expr $yy + 2`_TOTAL_DJF.nc $datpath/Precipitation/DJF/BPRD_trans_precip_`/usr/bin/expr $yy + 3`_TOTAL_DJF.nc $datpath/Precipitation/DJF/BPRD_trans_precip_`/usr/bin/expr $yy + 4`_TOTAL_DJF.nc $datpath/Precipitation/DJF/BPRD_trans_precip_`/usr/bin/expr $yy + 5`_TOTAL_DJF.nc $datpath/Precipitation/DJF/BPRD_trans_precip_`/usr/bin/expr $yy + 6`_TOTAL_DJF.nc $datpath/Precipitation/DJF/BPRD_trans_precip_`/usr/bin/expr $yy + 7`_TOTAL_DJF.nc $datpath/Precipitation/DJF/BPRD_trans_precip_`/usr/bin/expr $yy + 8`_TOTAL_DJF.nc $datpath/Precipitation/DJF/BPRD_trans_precip_`/usr/bin/expr $yy + 9`_TOTAL_DJF.nc tmpprec.nc


#cdo seldate,`/usr/bin/expr $yy - 1`-12-01,`/usr/bin/expr $yy + 9`-02-28  tmpslp.nc tmpslp2.nc
#cdo seldate,`/usr/bin/expr $yy - 1`-12-01,`/usr/bin/expr $yy + 9`-02-28  tmpprec.nc tmpprec2.nc 

#cdo -f srv copy tmpslp2.nc tmpslp.srv
#cdo -f srv copy  tmpprec2.nc tmpprec.srv
...
#cdo -f srv copy -selvar,Z3 /storage/climatestor/PleioCEP/doensen/data/cyclone/TRANS.3501BP.cam.h1.$yy"_"`/usr/bin/expr $yy + 9`"_"01-01.sel.nc  tmpz1000.srv
#cdo -f srv copy -selvar,PRECT /storage/climatestor/PleioCEP/doensen/data/cyclone/TRANS.3501BP.cam.h1.$yy"_"`/usr/bin/expr $yy + 9`"_"01-01.sel.nc  PRECT.srv
#cdo -f srv copy -selvar,PSL /storage/climatestor/PleioCEP/doensen/data/cyclone/TRANS.3501BP.cam.h1.$yy"_"`/usr/bin/expr $yy + 9`"_"01-01.sel.nc PSL.srv
#cdo -f srv copy -selvar,WS /storage/climatestor/PleioCEP/doensen/data/cyclone/TRANS.3501BP.cam.h1.$yy"_"`/usr/bin/expr $yy + 9`"_"01-01.sel.nc WS.srv
#cdo -f srv copy /storage/climatestor/PleioCEP/doensen/data/extracted/TRANS.3501BP.cam2.h1.$yy"-"01-01.PRECT_py.nc  PRECT.srv
#cdo -f srv copy /storage/climatestor/PleioCEP/doensen/data/extracted/TRANS.3501BP.cam2.h1.$yy"-"01-01.PSL_py.nc  PSL.srv

#cdo -f srv copy $datpath/tempz1000.nc  $datpath/tempz1000.srv
#cdo -f srv copy $datpath/tempprec.nc $datpath/tempprec.srv
#cdo -f srv copy $datpath/temppsl.nc $datpath/temppsl.srv


#cdo -f srv copy $datpath/TRANS.3501BP.cam.h1.`/usr/bin/expr $yy`_`/usr/bin/expr $yy + 5`.z1000_merged.nc tmpz1000.srv
#cdo -f srv copy $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy`_`/usr/bin/expr $yy + 5`.PRECT_merged.nc PRECT.srv
#cdo -f srv copy $datpath/TRANS.3501BP.cam2.h1.`/usr/bin/expr $yy`_`/usr/bin/expr $yy + 5`.PSL_merged.nc PSL.srv
...
cat > extract_slp_prec.f90 <<EOF
      ...
      integer ntime
      parameter(ntime=14600)
      integer i,j,k,nn,month(ncmx,6),year(0:ncmx,6),datloc,jj(6),ii
      integer ih(8),islp(10000)
      integer  iic,t0,age,ilon,ilat,cat,date,realc,agetot,idumi,tmpvar
      integer tmpvar2,lon5,lon6,lat5,lat6,lat7,kkk
!      integer lonew(5000,10000),lanew(5000,10000)
!      integer agenew(3000,10000,3)
      integer icount(5000,6),acount(5000,6),agemin,lon1,lon2,lon3,lon4
      real dumi1,dumi2,sum,mean,lon,lat, zrad, zdep
      real     cz,di,gz,gznew(3000,10000,6) ,gzsort(10000)
      real dec1,quart1,med,quart2,dec2,rprec(144,96,ntime)
      real slp(144,96),prec(144,96),rslp(144,96,ntime),precm,precmm
      real ws(144,96),rws(144,96,ntime),wsm,wsmm
...
!            print*,k,date,islp(k)
 ...
 !           if (prec(i,j).lt.0.) print*,i,j,k,prec(i,j), rprec(i,j,k) 
      ...
      call precmean(prec,ilon, ilat, zrad, precm,precmm)
	call precmean(ws,ilon,ilat,zrad,wsm,wsmm)
	
      write(34,777) iic, t0, age, ilon, ilat, cat, date,cz, di, realc, gz, &
                    agetot , idumi, zrad, zdep, rslp(ilon, ilat,k)/100., precm,precmm,wsm,wsmm
!      print*,ilon, ilat,k,rslp(ilon, ilat,k)/100.
!      write(35,*)cz
!      write(36,*)rslp(ilon, ilat,k)

777   format(2i12,i4,2i4,i2,i9,e13.4,f7.3,i2,e13.4,i4,i7,f7.3,6e14.6) 
      goto 800
...
998   continue
      ...
      subroutine precmean(sprec,ilon, ilat, zrad, precm, precmm)
      implicit none
      integer i,j,k,ilon, ilat,l,m, icount
      integer ni, nj,nloout, nlaout
      real rlon,rlat,pi
      real sprec(144,96), zrad, precm,precmm
...
!                 print*,latxy,lonxy
                 ...
                 if (radxy .lt. zrad) then
                    precm =precm + sprec(l, m)
                    precmm =precmm + sprec(l, m) * sin(pi*(m)/nlaout)                    
                    icount = icount +1
                 end if
             end do 
         end do
...
#/bin/mv fort.30 fort_30_`/usr/bin/expr $yy`_`/usr/bin/expr $yy + 9`

#/bin/mv fort.34 fort_34_`/usr/bin/expr $yy`_`/usr/bin/expr $yy + 9`
