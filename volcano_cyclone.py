...
vars = ['precmean','wsmean','agetot','zdep','T','PREC','NAOI']
for year in strong:
    ...
    for i,yearmore in enumerate(yearsmore):
        ...
        dic[i+1]=[dfmore_norm_year,T_more_year,prec_more_year,NAOI_more_year]
    ...
    more1_xr.append(dic[1][1:4])
    more2_xr.append(dic[2][1:4])
    more3_xr.append(dic[3][1:4])
    more4_xr.append(dic[4][1:4])
    more5_xr.append(dic[5][1:4])
