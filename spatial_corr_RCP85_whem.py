...
dic_3D = {
        'Z500':path+'Z500_V300/Z500_RCP85_anom.nc',
          'PREC':path+'PREC/PREC_RCP85_anom.nc',
            'WS':path+'WS/WS_RCP85_anom.nc',
            'T850':path+'T850/T850_RCP85_3507_3601_anom.nc',
            'RWP':path+'RWP/RWP_RCP85_all_anom.nc',
           'PSL':path_cyclone+'cyclone_stats_RCP85_all_monmean_XL_99p_PSL.nc',
           'GZ':path_cyclone+'cyclone_stats_RCP85_all_monmean_XL_99p_GZ.nc',
           'CZ':path_cyclone+'cyclone_stats_RCP85_all_monmean_XL_99p_CZ.nc',
           'ZRAD':path_cyclone+'cyclone_stats_RCP85_all_monmean_XL_99p_ZRAD.nc',
           'ZDEP':path_cyclone+'cyclone_stats_RCP85_all_monmean_XL_99p_ZDEP.nc',
           'PRECMEAN':path_cyclone+'cyclone_stats_RCP85_all_monmean_XL_99p_PRECMEAN.nc',
           'PRECMAX':path_cyclone+'cyclone_stats_RCP85_all_monmean_XL_99p_PRECMAX.nc',
           'WSMEAN':path_cyclone+'cyclone_stats_RCP85_all_monmean_XL_99p_WSMEAN.nc',
           'WSMAX':path_cyclone+'cyclone_stats_RCP85_all_monmean_XL_99p_WSMAX.nc',
          }

dic_1D = {
        'Z500':path+'Z500_V300/Z500_RCP85_anom_whem.nc',
        'PREC':path+'PREC/PREC_RCP85_anom_whem.nc',
          'WS':path+'WS/WS_RCP85_anom_whem.nc',
          'T850':path+'T850/T850_RCP85_3507_3601_anom_whem.nc',
          'RWP':path+'RWP/RWP_RCP85_all_anom_whem.nc',
          'NAOI':path+'try_PSL/NAOI_RCP85.nc',
        'PSL':path_cyclone+'cyclone_stats_RCP85_all_whem_XL_99p_PSL.nc',
          'GZ':path_cyclone+'cyclone_stats_RCP85_all_whem_XL_99p_GZ.nc',
          'CZ':path_cyclone+'cyclone_stats_RCP85_all_whem_XL_99p_CZ.nc',
          'ZRAD':path_cyclone+'cyclone_stats_RCP85_all_whem_XL_99p_ZRAD.nc',
          'ZDEP':path_cyclone+'cyclone_stats_RCP85_all_whem_XL_99p_ZDEP.nc',
          'PRECMEAN':path_cyclone+'cyclone_stats_RCP85_all_whem_XL_99p_PRECMEAN.nc',
          'PRECMAX':path_cyclone+'cyclone_stats_RCP85_all_whem_XL_99p_PRECMAX.nc',
          'WSMEAN':path_cyclone+'cyclone_stats_RCP85_all_whem_XL_99p_WSMEAN.nc',
          'WSMAX':path_cyclone+'cyclone_stats_RCP85_all_whem_XL_99p_WSMAX.nc'}
...
for key_3D in dic_3D:
    ...
    #The 1D variable that is compared against the spatial 3D field
        ...
        for key in ['DJF','JJA']:
            ...
            ax.coastlines()
            corr.to_netcdf(path_cyclone+'corr/corr_RCP85_1D_{}_3D_{}_{}_whem_99p_XL.nc'.format(key_1D,key_3D,key))
            fig.tight_layout()
            fig.savefig(path_cyclone+'corr/corr_RCP85_1D_{}_3D_{}_{}_whem_99p_XL.png'.format(key_1D,key_3D,key))
            plt.close(fig)
