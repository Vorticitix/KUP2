...
mkdir /storage/climatestor/PleioCEP/doensen/data/cyclone_1805_2404

cd /storage/climatestor/PleioCEP/doensen/data/cyclone_1805_2404
...
set datpath = "/storage/climatestor/PleioCEP/doensen/data/extracted/Qtot"
...
cdo -f srv copy -selvar,PRECC TRANS.3501BP.cam.h1.${arr[1]}"_"$i{arr[10]}"_"01-01.sel.nc PRECC.srv
