...
export CESM_PATH="/storage/climatestor/PleioCEP/kim/cesm1.2_data/archive/TRANS.3501BP_2/"  #set path to the folder of CESM input
...
bash run_cesm_preprocessing.sh 3333 3333 -1502 Test
