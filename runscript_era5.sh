...
mkdir /storage/climatestor/PleioCEP/doensen/data/cyclone_era5_1981_2010

cd /storage/climatestor/PleioCEP/doensen/data/cyclone_era5_1981_2010
...
set datpath = "/storage/climatestor/PleioCEP/doensen/data/era5"



cdo -f srv copy $datpath/oro.nc oro.srv
...
set zeiger = `/usr/bin/expr $y - 1981`
...
#cdo -f nc -b F64 copy -mergetime $datpath/ERA5_${arr[1]}.nc $datpath/ERA5_${arr[2]}.nc $datpath/ERA5_${arr[3]}.nc $datpath/ERA5_${arr[4]}.nc $datpath/ERA5_${arr[5]}.nc $datpath/ERA5_${arr[6]}.nc $datpath/ERA5_${arr[7]}.nc $datpath/ERA5_${arr[8]}.nc $datpath/ERA5_${arr[9]}.nc $datpath/ERA5_${arr[10]}.nc ERA5_${arr[1]}_${arr[10]}_tmp.nc
#
#cdo -f nc -b F64 copy -mergetime $datpath/ERA5_${arr[1]}_sfc.nc $datpath/ERA5_${arr[2]}_sfc.nc $datpath/ERA5_${arr[3]}_sfc.nc $datpath/ERA5_${arr[4]}_sfc.nc $datpath/ERA5_${arr[5]}_sfc.nc $datpath/ERA5_${arr[6]}_sfc.nc $datpath/ERA5_${arr[7]}_sfc.nc $datpath/ERA5_${arr[8]}_sfc.nc $datpath/ERA5_${arr[9]}_sfc.nc $datpath/ERA5_${arr[10]}_sfc.nc ERA5_${arr[1]}_${arr[10]}_sfc_tmp.nc
#
#cdo -f nc -b F64 copy -mergetime $datpath/ERA5_${arr[1]}_mslp.nc $datpath/ERA5_${arr[2]}_mslp.nc $datpath/ERA5_${arr[3]}_mslp.nc $datpath/ERA5_${arr[4]}_mslp.nc $datpath/ERA5_${arr[5]}_mslp.nc $datpath/ERA5_${arr[6]}_mslp.nc $datpath/ERA5_${arr[7]}_mslp.nc $datpath/ERA5_${arr[8]}_mslp.nc $datpath/ERA5_${arr[9]}_mslp.nc $datpath/ERA5_${arr[10]}_mslp.nc ERA5_${arr[1]}_${arr[10]}_mslp_tmp.nc
#
#cdo -f nc -b F64 copy -mergetime $datpath/ERA5_${arr[1]}_tcwv.nc $datpath/ERA5_${arr[2]}_tcwv.nc $datpath/ERA5_${arr[3]}_tcwv.nc $datpath/ERA5_${arr[4]}_tcwv.nc $datpath/ERA5_${arr[5]}_tcwv.nc $datpath/ERA5_${arr[6]}_tcwv.nc $datpath/ERA5_${arr[7]}_tcwv.nc $datpath/ERA5_${arr[8]}_tcwv.nc $datpath/ERA5_${arr[9]}_tcwv.nc $datpath/ERA5_${arr[10]}_tcwv.nc ERA5_${arr[1]}_${arr[10]}_tcwv_tmp.nc
#
#
#cdo remapbil,cesm_grid ERA5_${arr[1]}_${arr[10]}_tmp.nc ERA5_${arr[1]}_${arr[10]}.nc
#cdo remapbil,cesm_grid ERA5_${arr[1]}_${arr[10]}_sfc_tmp.nc ERA5_${arr[1]}_${arr[10]}_sfc.nc
#cdo remapbil,cesm_grid ERA5_${arr[1]}_${arr[10]}_mslp_tmp.nc ERA5_${arr[1]}_${arr[10]}_mslp.nc
#cdo remapbil,cesm_grid ERA5_${arr[1]}_${arr[10]}_tcwv_tmp.nc ERA5_${arr[1]}_${arr[10]}_tcwv.nc
#rm ERA5_${arr[1]}_${arr[10]}_tmp.nc
#rm ERA5_${arr[1]}_${arr[10]}_sfc_tmp.nc
#rm ERA5_${arr[1]}_${arr[10]}_mslp_tmp.nc
#rm ERA5_${arr[1]}_${arr[10]}_tcwv_tmp.nc
...
cdo -f srv -b F32 copy -divc,9.81 -selvar,z -sellevel,1000  ERA5_${arr[1]}_${arr[10]}.nc tmpz1000.srv
cdo selvar,u -sellevel,850 ERA5_${arr[1]}_${arr[10]}.nc u_tmp.nc 
cdo selvar,v -sellevel,850 ERA5_${arr[1]}_${arr[10]}.nc v_tmp.nc
cdo chname,u,ws -sqrt -add -sqr u_tmp.nc -sqr v_tmp.nc ws_tmp.nc
cdo -f srv -b F32 copy -selvar,ws ws_tmp.nc WS.srv
cdo -f srv -b F32 copy -selvar,tcwv ERA5_${arr[1]}_${arr[10]}_tcwv.nc Q.srv
cdo -f srv -b F32 copy -divc,100 -selvar,msl ERA5_${arr[1]}_${arr[10]}_mslp.nc PSL.srv
cdo -f srv -b F32 copy -divc,1000 -selvar,mcpr ERA5_${arr[1]}_${arr[10]}_sfc.nc PRECC.srv
cdo -f srv -b F32 copy -divc,1000 -selvar,mlspr ERA5_${arr[1]}_${arr[10]}_sfc.nc PRECL.srv
cdo divc,1000 -selvar,mcpr ERA5_${arr[1]}_${arr[10]}_sfc.nc mcpr.nc
cdo divc,1000 -selvar,mlspr ERA5_${arr[1]}_${arr[10]}_sfc.nc mlspr.nc
cdo chname,mcpr,prect -add mcpr.nc mlspr.nc prect.nc
cdo -f srv -b F32 copy -selvar,prect prect.nc PRECT.srv
...
cat > extract_slp_prec.f90 <<EOF
	...
	real precl(144,96),rprecl(144,96,ntime),preclmmean,preclmmax
      ...
      Open (34,File="PRECL.srv",FORM='UNFORMATTED',ACCESS='SEQUENTIAL',status='OLD')
      Open (35,File="Q.srv",FORM='UNFORMATTED',ACCESS='SEQUENTIAL',status='OLD')
