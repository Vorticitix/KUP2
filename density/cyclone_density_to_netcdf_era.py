...
files = sorted(glob('/storage/climatestor/PleioCEP/doensen/data/cyclone_era5_1981_2010/fort_30_????_????'))
filez_to_write = 'count_cyclone/cyclone_count_era_{:04d}_{:04d}.nc'
