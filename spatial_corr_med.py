...
dic_1D = {
        'Z500':path+'Z500_V300/Z500_anom_med.nc',
        'PREC':path+'PREC/PREC_anom_med.nc',
          'WS':path+'WS/WS_anom_med.nc',
          'T850':path+'T850/T850_0005_3514_anom_med.nc',
          'RWP':path+'RWP/RWP_all_anom_med.nc',
          'NAOI':path+'try_PSL/NAOI.nc',
        'PSL':path_cyclone+'cyclone_stats_all_med_XL_99p_PSL.nc',
          'GZ':path_cyclone+'cyclone_stats_all_med_XL_99p_GZ.nc',
          'CZ':path_cyclone+'cyclone_stats_all_med_XL_99p_CZ.nc',
          'ZRAD':path_cyclone+'cyclone_stats_all_med_XL_99p_ZRAD.nc',
          'ZDEP':path_cyclone+'cyclone_stats_all_med_XL_99p_ZDEP.nc',
          'PRECMEAN':path_cyclone+'cyclone_stats_all_med_XL_99p_PRECMEAN.nc',
          'PRECMAX':path_cyclone+'cyclone_stats_all_med_XL_99p_PRECMAX.nc',
          'WSMEAN':path_cyclone+'cyclone_stats_all_med_XL_99p_WSMEAN.nc',
          'WSMAX':path_cyclone+'cyclone_stats_all_med_XL_99p_WSMAX.nc'}
...
for key_3D in dic_3D:
    ...
    #The 1D variable that is compared against the spatial 3D field
        ...
        for key in ['DJF','JJA']:
            ...
            ax.coastlines()
            corr.to_netcdf(path_cyclone+'corr/corr_1D_{}_3D_{}_{}_med_99p_XL.nc'.format(key_1D,key_3D,key))
            fig.tight_layout()
            fig.savefig(path_cyclone+'corr/corr_1D_{}_3D_{}_{}_med_99p_XL.png'.format(key_1D,key_3D,key))
            plt.close(fig)
