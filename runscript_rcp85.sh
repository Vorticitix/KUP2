...
mkdir /storage/climatestor/PleioCEP/doensen/data/cyclone_RCP85_3512_3601

cd /storage/climatestor/PleioCEP/doensen/data/cyclone_RCP85_3512_3601
...
cdo -f srv copy -selvar,Z3 TRANS.3501BP.RCP85.cam.h1.${arr[1]}"_"${arr[10]}"_"01-01.sel.nc  tmpz1000.srv
cdo -f srv copy -selvar,PRECT TRANS.3501BP.RCP85.cam.h1.${arr[1]}"_"${arr[10]}"_"01-01.sel.nc  PRECT.srv
cdo -f srv copy -selvar,PSL TRANS.3501BP.RCP85.cam.h1.${arr[1]}"_"${arr[10]}"_"01-01.sel.nc PSL.srv
cdo -f srv copy -selvar,WS TRANS.3501BP.RCP85.cam.h1.${arr[1]}"_"${arr[10]}"_"01-01.sel.nc WS.srv
cdo -f srv copy -selvar,PRECL TRANS.3501BP.RCP85.cam.h1.${arr[1]}"_"${arr[10]}"_"01-01.sel.nc PRECL.srv
cdo -f srv copy -selvar,PRECC TRANS.3501BP.RCP85.cam.h1.${arr[1]}"_"${arr[10]}"_"01-01.sel.nc PRECC.srv
